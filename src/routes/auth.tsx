...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — DocMind AI" },
      { name: "description", content: "Sign in or create your DocMind AI account." },
    ],
  }),
  component: AuthPage,
});
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 w-1/2 border-r border-border bg-card/30">
        ...
        <div className="space-y-6 max-w-md">
          <h2 className="text-3xl font-bold tracking-tight">
            Your library, <span className="text-primary">queryable</span>.
          </h2>
          <p className="text-muted-foreground">
            Upload PDFs, notes, books and research. Ask anything — every answer comes with source citations from your own documents.
          </p>
          <div className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest pt-8">
            Trusted by researchers · students · legal teams
          </div>
        </div>
        <div className="text-xs text-muted-foreground">© 2026 DocMind AI</div>
      </div>
        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {mode === "signin" && "Sign in to your DocMind workspace."}
              {mode === "signup" && "Start chatting with your documents in 60 seconds."}
